...
>(({ className, inset, children, ...props }, ref) => (
  ...
  >
    {children}
    <Icon name="chevron-down" className="ml-auto h-4 w-4 -rotate-90" />
  </DropdownMenuPrimitive.SubTrigger>
));
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center rounded-xs px-2 py-1.5 text-sm outline-hidden transition-colors focus:bg-stone-100 focus:text-stone-900 data-disabled:pointer-events-none data-disabled:opacity-50 dark:focus:bg-stone-800 dark:focus:text-stone-50",
      inset && "pl-8",
      className,
    )}
    {...props}
